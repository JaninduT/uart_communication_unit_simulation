...
#
# Generated by export_simulation on Sat Jul 18 20:07:58 +0530 2020
#
################################################################################
...
'-reset_run' switch to the './axi_uartlite_1.sh' script.

./axi_uartlite_1.sh -reset_run
...
./axi_uartlite_1.sh -noclean_files

For more information on the script, please type './axi_uartlite_1.sh -help'.
