...
HD_PWD='C:/Users/User/Documents/practical/practical.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_schm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_schm.tcl
